...
do
    ...
    python chcardMaker.py -f ${SOURCE}/testPlot_TauTau_VBF/VBF_TauTau_11Gen18_2/analyzedOutPlotter.root -o "_${OUTSTRING}" -c ${c} -i ${SOURCE}/config/mainCfg_VBF_${c}.cfg -s ${BASE} ${RESONANT} -u 0 -t
#done
